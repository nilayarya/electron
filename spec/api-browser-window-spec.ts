        ...
        beforeEach(async () => {
          ...
          w = new BrowserWindow({
            ...
            windowStateRestoreOptions: {
              stateId,
              // @ts-ignore: Don't restore bounds since we're testing only saving window state
              bounds: false,
              // @ts-ignore: Don't restore display mode since we're testing only saving window state
              displayMode: false
            }
          });
        });
